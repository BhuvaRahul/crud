...
class AppTheme {
  ...
  static final lightTheme = _baseTheme(
    Brightness.light,
    accentColor: ColorUtils.o0xFF0669F8,
    onAccentColor: ColorUtils.whiteColor,
    scaffoldBackgroundColor: ColorUtils.o0xFFDCDFE2,
  ).copyWith(
    cardColor: ColorUtils.o0xFFCACFD6,
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      backgroundColor: ColorUtils.oxFFFAFAFA,
    ),
  );

  static final darkTheme = _baseTheme(
    Brightness.dark,
    accentColor: ColorUtils.tealAccentColor,
    onAccentColor: ColorUtils.blackColor,
    scaffoldBackgroundColor: ColorUtils.o0xFF040F2D,
  ).copyWith(
    cardColor: ColorUtils.o0xFF091642,
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      backgroundColor: ColorUtils.o0xFF050C25,
    ),
  );
}
